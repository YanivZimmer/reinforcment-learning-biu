...
UPDATE_SECOND_NET_INTERVAL=1000
print(f'..................{MODEL.name}..................')
...
class ActorCritic(RLModel):
    ...
    def calculate_lr(self):
        ...
        logging.info(f'lr to 0.95*lr={self.alpha} ,{self.alpha}')
...
class AgentDDQNT(RLModel):
    ...
    def calculate_lr(self):
        ...
        logging.info(f'lr to 0.95 * lr ={self.lr}')
    ...
    def learn(self):
        ...
        if self.memory.memory_counter%self.update_second_net_interval==0:
            ...
            self.update_second_net_interval()
